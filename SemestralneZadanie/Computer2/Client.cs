...
class UDP_client
{
    public void send_message(string udpIP, int udpPort, string msg, Header.HeaderData headerData)
    {
        ...
        Buffer.BlockCopy(messageBytes, 0, dataToSend, headerBytes.Length,
            messageBytes.Length); // Copy message after header
